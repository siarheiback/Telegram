...
extern "C" JNIEXPORT jintArray Java_org_telegram_bautrukevich_MrzRecognizer_findCornerPoints(JNIEnv* env, jclass clasz, jobject bitmap){
...
extern "C" JNIEXPORT jobjectArray Java_org_telegram_bautrukevich_MrzRecognizer_binarizeAndFindCharacters(JNIEnv* env, jclass clasz, jobject inBmp, jobject outBmp){
...
extern "C" JNIEXPORT jstring Java_org_telegram_bautrukevich_MrzRecognizer_performRecognition(JNIEnv* env, jclass clasz, jobject bitmap, jint numRows, jint numCols, jobject jAssetManager){
...
extern "C" JNIEXPORT void Java_org_telegram_bautrukevich_MrzRecognizer_setYuvBitmapPixels(JNIEnv* env, jclass clasz, jobject bitmap, jbyteArray jpixels){
