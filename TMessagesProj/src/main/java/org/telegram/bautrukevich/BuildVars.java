...
public class BuildVars {
    ...
    public static int APP_ID = 27831308;
    public static String APP_HASH = "7d07e2b7a687faa0a11db82475d053d6";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "org.telegram.bautrukevich.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
