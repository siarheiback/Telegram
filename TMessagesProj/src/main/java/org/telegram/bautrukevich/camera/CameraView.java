...
package org.telegram.bautrukevich.camera;
...
import org.telegram.bautrukevich.video.MediaCodecVideoConvertor;
...
//                }
    ...
    private void updateCameraInfoSize(int i) {
        ...
        org.telegram.bautrukevich.camera.Size aspectRatio;
        int wantedWidth;
        int wantedHeight;
